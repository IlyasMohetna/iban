...
return
 [
     ...
     'JO' => [
         ...
         'iban_print_format_example' => 'JO94 CBJO 0010 0000 0000 0131 0003 02',
         'bank_identifier_position' => '5-8',
         'bank_identifier_structure' => '4!n',
         'bank_identifier_regex' => '/^\\d{4}$/',
         'branch_identifier_position' => '5-8',
         'branch_identifier_structure' => '4!n',
     ...
     'LB' => [
         ...
         'iban_length' => 28,
         'bban_length' => 24,
         'iban_electronic_format_example' => 'LB62099900000001001901229114',
         'iban_print_format_example' => 'LB62 0999 0000 0001 0019 0122 9114',
         'bank_identifier_position' => '1-4',
         'bank_identifier_structure' => '4!a',
         'bank_identifier_regex' => '/^[A-Z]{4}$/',
         'branch_identifier_position' => '',
     ...
     'LY' => [
         ...
         'iban_length' => 25,
         'bban_length' => 21,
         'iban_electronic_format_example' => 'LY83002048000020100120361',
         'iban_print_format_example' => 'LY83 002 048 000020100120361',
         'bank_identifier_position' => '1-3',
         'bank_identifier_structure' => '3!n',
         'bank_identifier_regex' => '/^\\d{3}$/',
         'branch_identifier_position' => '4-6',
     ...
     'MC' => [
         ...
         'iban_length' => 27,
         'bban_length' => 23,
         'iban_electronic_format_example' => 'MC5811222000010123456789030',
         'iban_print_format_example' => 'MC58 1122 2000 0101 2345 6789 030',
         'bank_identifier_position' => '1-5',
         'bank_identifier_structure' => '5!n',
         'bank_identifier_regex' => '/^\\d{5}$/',
         'branch_identifier_position' => '6-10',
     ...
     'MK' => [
         ...
         'iban_length' => 19,
         'bban_length' => 15,
         'iban_electronic_format_example' => 'MK07250120000058984',
         'iban_print_format_example' => 'MK07 2501 2000 0058 984',
         'bank_identifier_position' => '1-3',
         'bank_identifier_structure' => '3!n',
         'bank_identifier_regex' => '/^\\d{3}$/',
         'branch_identifier_position' => '',
     ...
     'MN' => [
         ...
         'iban_length' => 20,
         'bban_length' => 16,
         'iban_electronic_format_example' => 'MN121234123456789123',
         'iban_print_format_example' => 'MN12 1234 1234 5678 9123',
         'bank_identifier_position' => '1-4',
         'bank_identifier_structure' => '4!n',
         'bank_identifier_regex' => '/^\\d{4}$/',
         'branch_identifier_position' => '',
     ...
     'MU' => [
         ...
         'iban_regex' => '/^MU\\d{2}[A-Z]{4}\\d{2}\\d{2}\\d{12}\\d{3}[A-Z]{3}$/',
         'bban_regex' => '/^[A-Z]{4}\\d{2}\\d{2}\\d{12}\\d{3}[A-Z]{3}$/',
         'iban_length' => 30,
         'bban_length' => 26,
         ...
         'bank_identifier_structure' => '6!c',
         'bank_identifier_regex' => '/^[A-Z0-9]{6}$/',
     ...
     'SC' => [
         ...
         'iban_regex' => '/^SC\\d{2}[A-Z]{4}\\d{2}\\d{2}\\d{16}[A-Z]{3}$/',
         'bban_regex' => '/^[A-Z]{4}\\d{2}\\d{2}\\d{16}[A-Z]{3}$/',
         'iban_length' => 31,
         'bban_length' => 27,
         'iban_electronic_format_example' => 'SC18SSCB11010000000000001497USD',
         'iban_print_format_example' => 'SC18 SSCB 1101 0000 0000 0000 1497 USD',
         'bank_identifier_position' => '1-6',
         'bank_identifier_structure' => '4!a2!n',
         'bank_identifier_regex' => '/^[A-Z]{4}\\d{2}$/',
         'branch_identifier_position' => '7-8',
         'branch_identifier_structure' => '2!n',
         'branch_identifier_regex' => '/^\\d{2}$/',
     ],
     'SD' => [
         ...
         'iban_length' => 18,
         'bban_length' => 14,
         'iban_electronic_format_example' => 'SD2129010501234001',
         'iban_print_format_example' => 'SD21 2901 0501 2340 01',
         'bank_identifier_position' => '1-2',
         'bank_identifier_structure' => '2!n',
         'bank_identifier_regex' => '/^\\d{2}$/',
         'branch_identifier_position' => '',
